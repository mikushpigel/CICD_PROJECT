def call() {
    withCredentials([aws(credentialsId: 'aws_access', accessKeyVariable: 'AWS_ACCESS_KEY_ID', secretKeyVariable: 'AWS_SECRET_ACCESS_KEY')]) {
        ...
        # Tag and push
        docker tag task-manager-app 471112876520.dkr.ecr.eu-central-1.amazonaws.com/task-manager-app:${VERSION}
        docker push 471112876520.dkr.ecr.eu-central-1.amazonaws.com/task-manager-app:${VERSION}
        """
    }
}